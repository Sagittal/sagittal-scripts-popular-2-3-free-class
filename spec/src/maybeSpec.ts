import { Max, Vector, Two3FreeClass, Rough, Super, Rational } from "@sagittal/general"
...
describe("computeMaybePopular23FreeClass", (): void => {
    it("returns a popular 2,3-free class if the N2D3P9 is under the max and the vector is super", (): void => {
        const two3FreeVector = [0, 0, 1] as Vector<Rational & Super & Rough<5>>
        const maxN2D3P9 = 5 as Max<N2D3P9>

        const actual = computeMaybePopular23FreeClass({ vector: two3FreeVector } as Two3FreeClass, maxN2D3P9)
